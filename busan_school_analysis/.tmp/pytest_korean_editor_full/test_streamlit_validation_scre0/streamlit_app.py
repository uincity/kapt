...
page = st.sidebar.selectbox("메뉴", pages, format_func=lambda value: page_labels[value])
...
if page == "Overview":
    ...
    render_relation_editor(ROOT, frames["relations"], frames["detail"], frames["feeders"])
